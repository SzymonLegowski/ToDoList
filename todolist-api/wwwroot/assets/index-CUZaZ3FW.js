      ...
      return openBlock(), createBlock(Transition, { name: "fade" }, {
        default: withCtx(() => [
          visible.value ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass(["alert", alertType.value])
...
const Alert = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-4374e205"]]);
const _sfc_main$5 = {
  __name: "App",
  setup(__props) {
    return (_ctx, _cache) => {
...
const useAuthStore = /* @__PURE__ */ defineStore("auth", () => {
  ...
  async function login(form, router2) {
    try {
      const res = await instance.post("/auth/login", form.value);
  ...
  async function register(form) {
    try {
      const res = await instance.post("/Auth/register", form.value);
...
const _hoisted_2$3 = { class: "form-header" };
const _hoisted_3$3 = {
  class: "submit-button",
  type: "submit"
};
      ...
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [
          (openBlock(), createElementBlock("div", {
            key: isRegister.value,
            class: "container"
          }, [
            createBaseVNode("div", _hoisted_1$3, [
              createBaseVNode("div", _hoisted_2$3, toDisplayString(isRegister.value ? "Rejestracja" : "Logowanie"), 1),
              createBaseVNode("form", {
                class: "form",
                onSubmit: _cache[2] || (_cache[2] = withModifiers(($event) => submit(form.value), ["prevent"]))
              }, [
                createBaseVNode("div", null, [
                  _cache[4] || (_cache[4] = createBaseVNode("label", { for: "email" }, "Login", -1)),
                ...
                createBaseVNode("div", null, [
                  _cache[5] || (_cache[5] = createBaseVNode("label", { for: "password" }, "Hasło", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("button", _hoisted_3$3, toDisplayString(isRegister.value ? "Zarejestruj się" : "Zaloguj się"), 1)
              ], 32),
              createBaseVNode("button", {
                class: "switch-button",
                onClick: _cache[3] || (_cache[3] = ($event) => isRegister.value = !isRegister.value)
              }, toDisplayString(isRegister.value ? "Logowanie" : "Utwórz konto"), 1)
            ])
          ]))
        ]),
        _: 1
...
const AuthView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-ced76281"]]);
const _hoisted_1$2 = { class: "form-wrapper" };
const _hoisted_2$2 = { class: "form-title" };
const _hoisted_3$2 = { class: "form-group" };
const _hoisted_4$1 = { class: "form-group" };
const _hoisted_5$1 = { class: "form-group" };
const _hoisted_6$1 = { class: "form-actions" };
const _hoisted_7$1 = {
  type: "submit",
  class: "submit-btn"
};
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("h2", _hoisted_2$2, toDisplayString(__props.isEditMode ? "Edytuj zadanie" : "Dodaj nowe zadanie"), 1),
        createBaseVNode("form", {
          onSubmit: withModifiers(handleSubmit, ["prevent"]),
          class: "todo-form"
        }, [
          createBaseVNode("div", _hoisted_3$2, [
            _cache[4] || (_cache[4] = createBaseVNode("label", { for: "title" }, "Tytuł", -1)),
            withDirectives(createBaseVNode("input", {
              type: "text",
              id: "title",
          ...
          createBaseVNode("div", _hoisted_4$1, [
            _cache[5] || (_cache[5] = createBaseVNode("label", { for: "description" }, "Opis", -1)),
          ...
          createBaseVNode("div", _hoisted_5$1, [
            _cache[6] || (_cache[6] = createBaseVNode("label", { for: "date" }, "Data", -1)),
            withDirectives(createBaseVNode("input", {
              type: "date",
              id: "date",
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => form.value.date = $event),
              required: ""
            }, null, 512), [
          ...
          createBaseVNode("div", _hoisted_6$1, [
            createBaseVNode("button", _hoisted_7$1, toDisplayString(__props.isEditMode ? "Zapisz zmiany" : "Dodaj zadanie"), 1),
            createBaseVNode("button", {
              type: "button",
              class: "cancel-btn",
...
const TodoItemForm = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e7f9228c"]]);
const _hoisted_1$1 = { class: "todo-list" };
const _hoisted_2$1 = { class: "filter-date" };
const _hoisted_3$1 = { class: "items" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        _cache[5] || (_cache[5] = createBaseVNode("h2", { class: "header" }, "Lista zadań", -1)),
        createBaseVNode("div", _hoisted_2$1, [
          _cache[3] || (_cache[3] = createBaseVNode("label", { for: "filter" }, "Pokaż zadania z dnia:", -1)),
          withDirectives(createBaseVNode("input", {
            id: "filter",
            type: "date",
          ...
          createBaseVNode("button", {
            onClick: _cache[1] || (_cache[1] = ($event) => selectedDate.value = ""),
            class: "clear-btn"
          }, "Wyczyść filtr"),
          _cache[4] || (_cache[4] = createBaseVNode("div", { style: { "width": "20%" } }, null, -1)),
          createBaseVNode("button", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(filteredItems.value, (item, index) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("h3", _hoisted_5, toDisplayString(item.title), 1),
                createBaseVNode("p", _hoisted_6, toDisplayString(item.description), 1),
                createBaseVNode("span", _hoisted_7, "Termin: " + toDisplayString(formatDate(item.date)), 1)
              ]),
...
const TodoItemList = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-33d3444d"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", _hoisted_1, [
        _cache[2] || (_cache[2] = createBaseVNode("div", { class: "app-name-container" }, " ToDo List ", -1)),
        createBaseVNode("div", _hoisted_2, [
          _cache[1] || (_cache[1] = createTextVNode(" Zalogowany jako: ")),
          createBaseVNode("span", _hoisted_3, toDisplayString(__props.username), 1)
        ]),
        createBaseVNode("button", {
          class: "logout-btn",
          onClick: _cache[0] || (_cache[0] = ($event) => emit2("logout"))
        }, "Wyloguj")
      ]);
    };
  }
};
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a7fddc56"]]);
const _sfc_main = {
  __name: "Dashboard",
  setup(__props) {
    const auth = useAuthStore();
    ...
    const TodoitemsRepository2 = inject("TodoitemsRepository");
    const isEditMode = ref(false);
    onMounted(async () => {
      todoitems.value = await TodoitemsRepository2.getAll();
    });
    ...
    async function deleteTodoitem(tdi) {
      await TodoitemsRepository2.delete(tdi.id);
    ...
    async function submitForm(tdi) {
      if (todoitem.value?.id) {
        await TodoitemsRepository2.update(todoitem.value.id, tdi);
        let index = todoitems.value.findIndex((tdi2) => tdi2.id === todoitem.value.id);
        ...
        let createdTodoitem = await TodoitemsRepository2.add(tdi);
    ...
    const logout = () => auth.logout(router2);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        (openBlock(), createBlock(resolveDynamicComponent(selectedComponent.value), {
          ...
          onSubmit: submitForm,
          onCancel: _cache[0] || (_cache[0] = ($event) => component.value = "list")
        }, null, 40, ["todoitem", "todoItems", "isEditMode"]))
      ], 64);
    };
  }
};
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/dashboard", name: "dashboard", component: _sfc_main, meta: { requiresAuth: true } },
...
class Repository {
  constructor(emitter2) {
    ...
    this.httpRequest = new HttpRequest(emitter2);
    this.resource = new.target.name.replace("Repository", "").toLowerCase();
  }
  async getAll() {
    return await this.httpRequest.send("GET", `/${this.resource}`);
  }
  async getById(id) {
    return await this.httpRequest.send("GET", `/${this.resource}/${id}`);
  }
  async add(form) {
    return await this.httpRequest.send("POST", `/${this.resource}`, form);
  }
  async update(id, form) {
    return await this.httpRequest.send("PUT", `/${this.resource}/${id}`, form);
  }
  async delete(id) {
    return await this.httpRequest.send("DELETE", `/${this.resource}/${id}`);
  }
}
class TodoitemsRepository extends Repository {
  async getByDate(date) {
    return await this.httpRequest.send("GET", `/api/${this.resource}`, { date });
  }
}
